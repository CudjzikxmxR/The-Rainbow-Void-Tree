...
addLayer("k", {
    ...
    milestones: {
        ...
        18: {
            ...
            effectDescription() {
                return "+0.05 to the <b>6 Killstreak</b> and <b>10 Killstreak</> effect base for every Killstreak milestone past this point, including this.<br>Currently: "+format((player['k'].milestones.length-7)/20)
            },
