...
addLayer("farm", {
    ...
    effectDescription() {
        return "which boosts your click power by "+format((new Decimal(1.2)).pow(player[this.layer].points))+"x"
    },
    baseAmount() {return player.points}, // Get the current amount of baseResource
    type: "static", // normal: cost to gain currency depends on amount gained. static: cost depends on how much you already have
    softcap: new Decimal(1e6), 
    ...
    upgrades: {
        ...
        1001: {
            title: "Wheat",
            description: "<i>The first crop in the entire game. A long journey awaits...</i><br><br>Value: $"+format(getCropValue(this.id-1001)),
            cost: new Decimal(0),
            style: {'width':'140px'},
            onPurchase() {
