...
addLayer("k", {
    ...
    milestones: {
        ...
        24: {
            ...
            effectDescription() {
                return "Click-related multipliers can no longer drain.<br>Click power scales based on your current click-related Rainbow multiplier.<br>Currently: "+format(upgradeEffect('p', 16).pow(0.3))+"x"
            },
