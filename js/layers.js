...
addLayer("g", {
    ...
    milestones: {
        17: {
            ...
            effectDescription: "You can feed Axe Cat, disabling Amoeba gain entirely and causing Catfood to spawn around the screen, but giving temporary Rainbow and Cherry multiplier for each Catfood clicked.",
            toggles: [
                ["p", "feedingAxeCat"], 
            ],
