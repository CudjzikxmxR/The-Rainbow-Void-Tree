    ...
    */
    ...
    tabFormat: [
        ...
        ["display-text", function () {
            ...
            return "You currently have <font color='#F7B100'>" + player["a"].achievements.length + "</font> achievements, which translates to a " + format(new Decimal(achieveBase).pow(player["a"].achievements.length)) + "x Rainbow multiplier."
        }],
        ["display-text", function () {
            if (!hasUpgrade('p', 28)) {
               return null
